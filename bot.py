...
if BOT_TOKEN == "PASTE_YOUR_BOT_TOKEN_HERE":
    raise RuntimeError("Please put your BotFather token in BOT_TOKEN at the top of bot.py.")

if not ADMIN_IDS or 123456789 in ADMIN_IDS:
    raise RuntimeError("Please replace the example ADMIN_IDS value with your Telegram user ID.")
